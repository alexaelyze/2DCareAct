...
$quizScores = [
    ['id' => 'vitals',   'link' => 'vitalsquizscore.php',   'fallback' => 'CHECKING VITAL SIGNS'],
    ['id' => 'cpr',      'link' => 'cprquizscore.php',      'fallback' => 'CPR TRAINING'],
    ['id' => 'mobility', 'link' => 'mobilityquizscore.php', 'fallback' => 'ASSISTED MOBILITY'],
    ['id' => 'infant',   'link' => 'infantquizscore.php',   'fallback' => 'INFANT CARE'],
    ['id' => 'hygiene',  'link' => 'hygienequizscore.php',  'fallback' => 'ELDERLY HYGIENE AND GROOMING'],
];

$simScores = [
    ['id' => 'vitalsignsimulation', 'link' => 'vitalssimulationscore.php',   'fallback' => 'CHECKING VITAL SIGNS'],
    ['id' => 'cpr_simulation',      'link' => 'cprsimulationscore.php',       'fallback' => 'CPR TRAINING'],
    ['id' => 'mobilitysimulation',  'link' => 'mobilitysimulationscore.php',  'fallback' => 'ASSISTED MOBILITY'],
    ['id' => 'infantsimulation',    'link' => 'infantsimulationscore.php',    'fallback' => 'INFANT CARE'],
    ['id' => 'hygienesimulation',   'link' => 'hygienesimulationscore.php',   'fallback' => 'ELDERLY HYGIENE AND GROOMING'],
];
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="container">
  ...
  <!-- ===== QUIZ SCORES ===== -->
  <div class="section">
    <div class="section-heading">Quiz Scores</div>
    <div class="grid">
      <?php foreach ($quizScores as $i => $q):
        $num   = $i + 1;
      ...
      <div class="card-wrap">
        ...
        <a href="<?php echo $q['link']; ?>" class="card">
  ...
  <!-- ===== SIMULATION SCORES ===== -->
  <div class="section">
    <div class="section-heading">Simulation Scores</div>
    <div class="grid">
      <?php foreach ($simScores as $i => $s):
        $num   = $i + 1;
